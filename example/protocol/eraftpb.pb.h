...
class Entry : public ::google::protobuf::Message {
 public:
  ...
  inline ::eraftpb::EntryType entry_type() const;
  inline void set_entry_type(::eraftpb::EntryType value);
...
class SnapshotMetadata : public ::google::protobuf::Message {
 public:
  ...
  inline const ::eraftpb::ConfState& conf_state() const;
  inline ::eraftpb::ConfState* mutable_conf_state();
  inline ::eraftpb::ConfState* release_conf_state();
  inline void set_allocated_conf_state(::eraftpb::ConfState* conf_state);
...
class Snapshot : public ::google::protobuf::Message {
 public:
  ...
  inline const ::eraftpb::SnapshotMetadata& metadata() const;
  inline ::eraftpb::SnapshotMetadata* mutable_metadata();
  inline ::eraftpb::SnapshotMetadata* release_metadata();
  inline void set_allocated_metadata(::eraftpb::SnapshotMetadata* metadata);
...
class Message : public ::google::protobuf::Message {
 public:
  ...
  inline ::eraftpb::MessageType msg_type() const;
  inline void set_msg_type(::eraftpb::MessageType value);
  ...
  inline bool has_log_term() const;
  inline void clear_log_term();
  static const int kLogTermFieldNumber = 5;
  inline ::google::protobuf::uint64 log_term() const;
  inline void set_log_term(::google::protobuf::uint64 value);
  ...
  inline const ::eraftpb::Entry& entries(int index) const;
  inline ::eraftpb::Entry* mutable_entries(int index);
  inline ::eraftpb::Entry* add_entries();
  ...
  inline const ::eraftpb::Snapshot& snapshot() const;
  inline ::eraftpb::Snapshot* mutable_snapshot();
  inline ::eraftpb::Snapshot* release_snapshot();
  inline void set_allocated_snapshot(::eraftpb::Snapshot* snapshot);
  ...
  inline bool has_reject_hint() const;
  inline void clear_reject_hint();
  static const int kRejectHintFieldNumber = 11;
  inline ::google::protobuf::uint64 reject_hint() const;
  inline void set_reject_hint(::google::protobuf::uint64 value);
...
inline ::eraftpb::ConfState* SnapshotMetadata::mutable_conf_state() {
  set_has_conf_state();
  if (conf_state_ == NULL) conf_state_ = new ::eraftpb::ConfState;
...
inline ::eraftpb::SnapshotMetadata* Snapshot::mutable_metadata() {
  set_has_metadata();
  if (metadata_ == NULL) metadata_ = new ::eraftpb::SnapshotMetadata;
...
inline ::eraftpb::Snapshot* Message::mutable_snapshot() {
  set_has_snapshot();
  if (snapshot_ == NULL) snapshot_ = new ::eraftpb::Snapshot;
